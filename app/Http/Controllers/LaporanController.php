                        ...
                        if ($rtls->isNotEmpty()) {
                            foreach ($rtls as $rtl) {
                                $rows->push((object) [
                                    ...
                                    'uraian_realisasi' => $rtl->uraian_realisasi ?: '-',
                                    'waktu_pelaksanaan' => $rtl->waktu_pelaksanaan ? $rtl->waktu_pelaksanaan->translatedFormat('d/m/Y') : '-',
                                    'catatan' => $rtl->catatan ?: '',
                                    'tindak_lanjut_text' => $temuan->rencana_awal ?: '-',
